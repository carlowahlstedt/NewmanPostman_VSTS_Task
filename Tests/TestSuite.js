...
describe('Error handling', function () {
    ...
    it('Error if no match file in collection directory', (done) => {
        this.timeout(1000);
...
describe('Normal behavior', function () {
    ...
    it('When a folder is set as source, collection in this dir are used', (done) => {
        this.timeout(1000);
    ...
    it('When path to newman is set, this one is used', (done) => {
        this.timeout(1000);
